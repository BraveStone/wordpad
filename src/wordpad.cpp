...
class  KMessageFiter : public IMessageFilter
{
public:
	KMessageFiter()
	{
...
BOOL CWordPadApp::InitInstance()
{
	...
	{
		IMessageFilter* msgFiter =(IMessageFilter*) new KMessageFiter();;
		//g_messgeFiter.QueryInterface(IID_IMessageFilter, (void**)&msgFiter);
		::CoRegisterMessageFilter(msgFiter, NULL);
	}
	RegisterFormats();
