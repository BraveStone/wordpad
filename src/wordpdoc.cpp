...
CDocObjectServer* CWordPadDoc::GetDocObjectServer(LPOLEDOCUMENTSITE pDocSite)
{
	if (!m_pDocObjectServer)
	{
		//m_pDocObjectServer = (CDocObjectServer*)(new CDocObject(this));
	}
	return m_pDocObjectServer;
}